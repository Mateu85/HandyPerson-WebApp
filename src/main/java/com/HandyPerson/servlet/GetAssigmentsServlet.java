...
public class GetAssigmentsServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        out.println("<head>\n" +
                ...
                "</head>");
        out.println("<div>");
        out.println("<button style=\"width: 100%;border-radius: 0px !important\" type=\"button\" class=\"btn btn-secondary btn-lg btn-block\"onClick=\"parent.location='index.jsp'\">Back To Menu</button>");
        out.println("<div>");
        ...
        for (Task task : tasks) {
            ...
            out.println("<a class=\"text-secondary text-decoration-none text-danger\" href='delete-book?id=" + task.getId() + "'> DELETE</a>");
            out.println("</li>");
        }
        out.println("</ul>");
        out.println("</div>");
